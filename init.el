...
(custom-set-variables
 ...
 '(package-selected-packages
   '(skewer-mode ccls lsp-treemacs treemacs lsp-pyright lsp-ui flycheck company lsp-mode emmet-mode key-chord evil projectile which-key smex ido-vertical-mode magit org-bullets hungry-delete switch-window dashboard swiper doom-themes use-package))
...
(setq httpd-root "/home/user/code/portfolio.github.io")
